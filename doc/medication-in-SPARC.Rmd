...
If a patient has medication information for the same drug from eCRF and EMR, the earliest MED_START_DATE is used and the latest MED_END_DATE. The columns MED_START_SOURCE and MED_END_SOURCE tell the data source of the respective date.
