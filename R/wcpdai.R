...
wpcdai <- function(data,
  ...
  # drop all tables from data which are not observation or encounter
  data$biosample = NULL
  data$demographics = NULL
  data$diagnosis = NULL
  data$family_history_demographics = NULL
  data$family_history_diagnosis = NULL
  data$master_patient = NULL
  data$omics_patient_mapping = NULL
  data$patient_allergy = NULL
  data$patient_problem = NULL
  data$prescriptions = NULL
  data$procedures = NULL
  data$study_eligibility_criteria_inclusion_exclusion = NULL
  data$study_eligibility_diagnosis_confirmation = NULL
  data$vaccines = NULL
