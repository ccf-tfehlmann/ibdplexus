...
#'
#' 1. user defines type of lab results to select
#' 2. user defines if searching for only LOINC codes, all codes or key words as well
#' 3. user defines if all or positive results (default "positive/elevated" definition or custom)
#' 4. user defines if only valid units for positive results or all positive results
#'
