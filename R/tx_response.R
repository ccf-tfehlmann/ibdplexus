  ...
  if (all_events == T) {
    ...
    dictionary <- data.frame(
      ...
      Definition = c(
        ...
        "Flag if disease activity date is during time when patient was also on steroids",
        ...
        "Date of Tissue RNASeq closest to disease activity date, within +/- 60 days of disease activity date",
        "Date of Tissue RNASeq closest to medication start date, within 30 days prior to medication started",
        "Date of Olink closest to disease activity date, within +/- 60 days of disease activity date",
        "Date of Olink closest to medication start date, within 30 days prior to medication started",
        "Date of Blood RNASeq closest to disease activity date, within +/- 60 days of disease activity date",
