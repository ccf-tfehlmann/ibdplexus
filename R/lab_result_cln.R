...
#'
#'
#' @param labemrdata A single dataframe with lab EMR records, from a list of dataframes, typically generated by a call to load_data. See example for extracting the lab EMR table from the load_data results.
#'
#'
...
#' #labemr = data$labs
#' #cleanedlabemr = lab_result_cln(labdata=labemr)
