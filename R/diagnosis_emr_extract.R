...
#' @param inclusion diagnosis category of ICD 10 codes to search for. Can choose between predefined categories (included codes are detailed in \code{\link{Diagnosis_EMR_Extract}} ) or enter a custom defined list.
