...
#' this file contains a function to extract relevant diagnosis codes from diagnosis and/or patient problem EMR data for a specific condition of interest
...
#' @param inclusion diagnosis category of ICD 10 codes to search for. Can choose between predefined categories (included codes are detailed in \code{\link{Diagnosis_EMR_Extract.html}} ) or enter a custom defined list.
