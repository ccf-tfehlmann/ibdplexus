---
title: "diagnosis_emr_extract User Guide"
...
This file contains a function to extract relevant diagnosis codes from diagnosis and/or patient problem emr data for a specific condition category of interest.

Future Updates:
1. Additional code to add indicator to patient level data for the presence of a diagnosis.
2. Relevant ICD 9 Codes to supplement ICD 10 codes.
